...
namespace NetStreams
{
    public interface INetStream<TKey, TMessage> : INetStream
    {
        ...
        INetStream<TKey, TMessage> Transform(Func<IConsumeContext<TKey, TMessage>, object> handleConsumeContext);
        INetStream<TKey, TMessage> TransformAsync(Func<IConsumeContext<TKey, TMessage>, Task<object>> handleConsumeContext);
    ...
    { 
        ...
        INetStream SetWriter(IStreamWriter writer);
    }
}
